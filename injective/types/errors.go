...
var (
	...
	ErrFeedDoesntExists          = sdkerrors.Register(ModuleName, 18, "feed doesnt exists")
	ErrAdminRestricted           = sdkerrors.Register(ModuleName, 18, "action is admin-restricted")
	ErrInsufficientRewardPool    = sdkerrors.Register(ModuleName, 19, "insufficient reward pool")
	ErrPayeeAlreadySet           = sdkerrors.Register(ModuleName, 20, "payee already set")
	ErrPayeeRestricted           = sdkerrors.Register(ModuleName, 21, "action is payee-restricted")
